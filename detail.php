<?php
    ...
    $access_token_url = 'https://api.mercadopago.com/oauth/token';
    $query = array( "client_id"     => '5427238671671770',
                    "client_secret" => '4PMGuFmXySAgXZ2EWoRkndrXCaPaLNz8',
    ...
    $data_body= '{
            ...
            "back_urls": {
                "success": "https://shrouded-retreat-14532.herokuapp.com/success.php",
                "failure": "https://shrouded-retreat-14532.herokuapp.com/failure.php",
                "pending": "https://shrouded-retreat-14532.herokuapp.com/pending.php"
            },
...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="https://sdk.mercadopago.com/js/v2" view="item"></script>

    <?php
        $url_pagar= 'https://auth.mercadopago.com/authorization?client_id=5427238671671770&response_type=code&platform_id=mp&state='.rand(0,5000).'&redirect_uri=https://shrouded-retreat-14532.herokuapp.com/';
    ?>
                            ...
                            <div class="width:60%">
                                        ...
                                        <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                            <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="6|Powerbeats3 Wireless Earphones - Neighborhood Collection - Brick Red|MPXP2">
                                                <div class="as-tilegallery-element as-image-selected">
                                                    <div class=""></div>
                                                    <img src="./assets/003.jpg" class="ir ir item-image as-producttile-image" alt="" width="445" height="445" style="content:-webkit-image-set(url(<?php echo isset($_POST['img'])? $_POST['img'] : ''; ?>) 2x);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2"><?php echo isset($_POST['title']) ? $_POST['title'] : '' ?></span>
                                                </p>
                                            </h3>
                                        </div>
                                        <h3 >
                                        ...
                                        <h3 >
                                            <?php echo "$" . isset($_POST['unit']) && !empty($_POST['unit']) ? $_POST['unit'] : '' ?>
                                        </h3>
                                    </div>
...
<script type="text/javascript">
    ...
    $(".mercadopago-button").on("click", function(){
        window.location= "<?php echo $init_point; ?>";
    });
